...
const BATTLEPASS_TIERS = [
  {tier:1,  xp:60,  free:{type:'coins',amount:20},                  premium:{type:'coins',amount:50}},
  {tier:2,  xp:130,  free:{type:'coins',amount:20},                  premium:{type:'consumable',consumableId:'candy_dungeon',qty:2}},
  {tier:3,  xp:210,  free:null,                                     premium:{type:'coins',amount:60}},
  {tier:4,  xp:305,  free:{type:'coins',amount:20},                  premium:{type:'consumable',consumableId:'candy_boss',qty:2}},
  {tier:5,  xp:415,  free:null,                                     premium:{type:'coins',amount:70}},
  {tier:6,  xp:530,  free:{type:'coins',amount:30},                  premium:{type:'consumable',consumableId:'candy_treasure',qty:2}},
  {tier:7,  xp:660, free:{type:'coins',amount:30},                  premium:{type:'consumable',consumableId:'candy_training',qty:2}},
  {tier:8,  xp:800, free:null,                                     premium:{type:'coins',amount:85}},
  {tier:9,  xp:955, free:{type:'coins',amount:35},                  premium:{type:'consumable',consumableId:'candy_dungeon',qty:4}},
  {tier:10, xp:1120, free:null,                                     premium:{type:'coins',amount:110}},
  {tier:11, xp:1295, free:{type:'coins',amount:35},                  premium:{type:'consumable',consumableId:'candy_boss',qty:4}},
  {tier:12, xp:1485, free:{type:'coins',amount:35},                  premium:{type:'consumable',consumableId:'candy_treasure',qty:4}},
  {tier:13, xp:1685, free:null,                                     premium:{type:'coins',amount:125}},
  {tier:14, xp:1900, free:{type:'coins',amount:45},                  premium:{type:'coins',amount:145}},
  {tier:15, xp:2150, free:null,                                     premium:{type:'consumable',consumableId:'candy_training',qty:4}},
  {tier:16, xp:2400, free:{type:'coins',amount:50},                  premium:{type:'consumable',consumableId:'candy_dungeon',qty:6}},
  {tier:17, xp:2610, free:{type:'coins',amount:50},                  premium:{type:'consumable',consumableId:'candy_boss',qty:6}},
  {tier:18, xp:2865, free:null,                                     premium:{type:'consumable',consumableId:'candy_training',qty:6}},
  {tier:19, xp:3135, free:{type:'coins',amount:65},                  premium:{type:'consumable',consumableId:'candy_treasure',qty:6}},
  {tier:20, xp:3500, free:{type:'coins',amount:100},                  premium:{type:'coins',amount:275}},
];
